...
/**
 * @brief TODO: 描述axk_heartbeat_init的功能
 *
 * @return 0成功, -1失败
 */
int axk_heartbeat_init(void);
/**
 * @brief TODO: 描述axk_heartbeat_tick的功能
 *
 * @return 无返回值
 */
void axk_heartbeat_tick(void);
/**
 * @brief TODO: 描述axk_heartbeat_set_report_enabled的功能
 *
 * @param enable TODO: 描述enable
 * @return 无返回值
 */
void axk_heartbeat_set_report_enabled(bool enable);
/**
 * @brief TODO: 描述axk_heartbeat_get_uptime_sec的功能
 *
 * @return 0成功, -1失败
 */
