...
/**
 * @brief TODO: 描述axk_kv_set_blob的功能
 *
...
/**
 * @brief TODO: 描述axk_kv_get_blob的功能
 *
 * @param key TODO: 描述key
 * @param buf TODO: 描述buf
 * @param buf_len TODO: 描述buf_len
 * @param saved_len TODO: 描述saved_len
 * @return 0成功, -1失败
 */
int axk_kv_get_blob(const char *key, void *buf, size_t buf_len, size_t *saved_len);
/**
 * @brief TODO: 描述axk_kv_del的功能
 *
 * @param key TODO: 描述key
 * @return 0成功, -1失败
 */
