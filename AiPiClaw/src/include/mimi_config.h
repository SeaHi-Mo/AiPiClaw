/**
 * @file mimi_config.h
 * @brief MimiClaw 全局config - 安信可科技 BL618 port
 * @version 1.0
 * @date 2026-04-20
...
/* Agent Loop */
#define MIMI_AGENT_STACK             (48 * 1024)
...
#define MIMI_MINIMAX_ANTHROPIC_API_URL  "https://api.minimaxi.com/anthropic/v1/messages"
...
/* 内存 / filesystem */
/* BL618use LittleFS替代SPIFFS，mount 点keep 兼容 */
...
/* GPIO */
#define MIMI_GPIO_CONFIG_SECTION     1   /* enable GPIOtool */
...
/* NVS命名empty 间（in BL618上由easyflash实现） */
